...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT INSERT, MAINTAIN, DELETE, TRIGGER, TRUNCATE, UPDATE, SELECT, REFERENCES ON TABLES TO service_role;
